...
unsigned long long spmv_cluster(
    const SPMV_MAT_PKT_T *matrix_hbm,       // in
    ...
    unsigned long long sf1_iter_cnt =
    ...
    vecbuf_access_unit<0, PACK_SIZE>(
        SF2VAU[0],
        UPK2VAU[0],
        VAU2SF[0],
        num_col_partitions,
    ...
    vecbuf_access_unit<1, PACK_SIZE>(
        SF2VAU[1],
        UPK2VAU[1],
        VAU2SF[1],
        num_col_partitions,
    ...
    vecbuf_access_unit<2, PACK_SIZE>(
        SF2VAU[2],
        UPK2VAU[2],
        VAU2SF[2],
        num_col_partitions,
    ...
    vecbuf_access_unit<3, PACK_SIZE>(
        SF2VAU[3],
        UPK2VAU[3],
        VAU2SF[3],
        num_col_partitions,
    ...
    vecbuf_access_unit<4, PACK_SIZE>(
        SF2VAU[4],
        UPK2VAU[4],
        VAU2SF[4],
        num_col_partitions,
    ...
    vecbuf_access_unit<5, PACK_SIZE>(
        SF2VAU[5],
        UPK2VAU[5],
        VAU2SF[5],
        num_col_partitions,
    ...
    vecbuf_access_unit<6, PACK_SIZE>(
        SF2VAU[6],
        UPK2VAU[6],
        VAU2SF[6],
        num_col_partitions,
    ...
    vecbuf_access_unit<7, PACK_SIZE>(
        SF2VAU[7],
        UPK2VAU[7],
        VAU2SF[7],
        num_col_partitions,
