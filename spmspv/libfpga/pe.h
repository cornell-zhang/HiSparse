...
//----------------------------------------------------------------
// static VAL_T pe_binary_operator(VAL_T a, VAL_T b, OP_T sr) {
...
// static VAL_T min(VAL_T a, VAL_T b) {
//     #pragma HLS inline
//     return (a < b) ? a : b;
// }

// static VAL_T pe_reduction_operator(VAL_T a, VAL_T b, OP_T sr) {
//     #pragma HLS pipeline II=1
